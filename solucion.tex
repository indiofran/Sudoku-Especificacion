...
9. \begin{proc}{sudoku\_esTableroParcialmenteResuelto}{\textbf{\In t}: \matriz{\ent}, \textbf{\Out result}: \bool }{}{}
	...
	\pred{noHayRepetidos}{s: \TLista{\ent}}{\\
        (\forall i: \ent)(\forall j: \ent)(enRango(s, i) $\land$ 
        enRango(s, j) $\land$
        j \neq i) $\implicaLuego$
        (s[i] \neq s[j])\\
        }
	...
	\pred{ColumnadeTableroParcialmenteResuelto}{t: \matriz{\ent}}{\\
        (\forall i: \ent)(\forall j: \ent)((enRango(t, i)  $\land$ enRango(t[i], k))$\implicaLuego$ (s = Concat(subseq(s[i], j, j+1)) $\land$  noHayRepetidos(s))\\
        }	
